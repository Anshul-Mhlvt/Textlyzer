...
rad=st.sidebar.radio("Navigation",["Home","Spam Detection","Sentiment Analysis","Stress Detection","Hate & Offensive Content Detection","Sarcasm Detection"])
...
if rad=="Home":
    ...
    st.text("4. Hate & Offensive Content Detection")
...
df1=pd.read_csv("Dataset/spam.csv")
...
df2=pd.read_csv("Dataset/sentiment.csv")
...
df4=pd.read_csv("Dataset/hate.csv")
...
df5=pd.read_csv("Dataset/sarcasm.csv")
